...
3. Run the following command:
   ...
   docker compose up
   ```
4. Look for a URL in the console output that starts with `http://127.0.0.1:8888/tree?token=...`. Open this URL in your web browser to access Jupyter Notebook.
